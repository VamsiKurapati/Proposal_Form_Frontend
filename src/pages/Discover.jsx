    ...
    <div className="bg-[#F8FAFC] rounded-xl p-4 shadow w-[355px] mr-4 flex flex-col justify-between">
      <div>
        <div className="flex items-center justify-between mb-2">
          {rfp.logo && <img src={rfp.logo} alt="Logo" className="w-12 h-12 rounded-full object-cover object-center" />}
          {(!rfp.logo || rfp.logo === "") && <div className="w-12 h-12 rounded-full bg-[#2563EB] flex items-center justify-center">
