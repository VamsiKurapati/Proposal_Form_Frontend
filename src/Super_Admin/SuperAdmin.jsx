...
const SuperAdmin = () => {
  ...
  const getPlanSection = (planName) => {
    ...
    return (
      <div
        className={`border rounded-2xl p-6 w-full h-[650px] shadow-md relative transition-transform hover:scale-105 flex flex-col ${
        ...
        {planName === "Basic" ? (
          <>
            ...
            <div className="flex items-center mb-4 relative bg-gray-200 rounded-full w-[160px] p-1 ml-[50%] -translate-x-1/2">
              ...
              <div
                className={`absolute top-1 left-1 w-[75px] h-[28px] rounded-full bg-[#6C63FF] transition-transform duration-300 ${
                  isYearlyb ? "translate-x-[78px]" : "translate-x-0"
                }`}
              ></div>

              {/* Monthly button */}
              <span
                className={`relative z-10 flex-1 text-center py-1 text-sm font-medium cursor-pointer transition-colors ${
        ...
        <ul className="space-y-2 mb-6">
          ...
          />
            ...
            <div className="flex items-center mb-4 relative bg-gray-200 rounded-full w-[160px] p-1 ml-[50%] -translate-x-1/2">
                    ...
                    <div
                        className={`absolute top-1 left-1 w-[75px] h-[28px] rounded-full bg-[#6C63FF] transition-transform duration-300 ${
                        isYearlyp ? "translate-x-[78px]" : "translate-x-0"
                        }`}
                    ></div>
            ...
            <div className="flex items-center mb-4 relative bg-gray-200 rounded-full w-[160px] p-1 ml-[50%] -translate-x-1/2">
                    ...
                    <div
                        className={`absolute top-1 left-1 w-[75px] h-[28px] rounded-full bg-[#6C63FF] transition-transform duration-300 ${
                        isYearlye ? "translate-x-[78px]" : "translate-x-0"
                        }`}
                    ></div>
                        ...
                        <div className="p-4 h-screen flex flex-col justify-between">
                            ...
                            <nav className="space-y-2">
                                ...
                                className={`w-full text-left text-white rounded-lg p-3 flex items-center justify-center lg:justify-start space-x-3 transition-colors ${
                                    activeTab === 'user-management' ? 'bg-[#6C63FF] text-white' : 'text-white'
                                }`}
                                onClick={() => {
                                    setActiveTab('user-management');
                                    closeAllInvoiceRows();
                                ...
                                <button
                                className={`w-full text-left text-white rounded-lg p-3 flex items-center justify-center lg:justify-start space-x-3 transition-colors ${
                                    activeTab === 'payments' ? 'bg-[#6C63FF] text-white' : 'text-white'
                                }`}
                                onClick={() => {
                                    setActiveTab('payments');
                                    closeAllInvoiceRows();
                                ...
                                <button
                                className={`w-full text-left text-white rounded-lg p-3 flex items-center justify-center lg:justify-start space-x-3 transition-colors ${
                                    activeTab === 'plan-management' ? 'bg-[#6C63FF] text-white' : 'text-white'
                                }`}
                                onClick={() => {
                                    setActiveTab('plan-management');
                                    closeAllInvoiceRows();
                                ...
                                <button
                                className={`w-full text-left text-white rounded-lg p-3 flex items-center justify-center lg:justify-start space-x-3 transition-colors ${
                                    activeTab === 'support' ? 'bg-[#6C63FF] text-white' : 'text-white'
                                }`}
                                onClick={() => {
                                    setActiveTab('support');
                                    closeAllInvoiceRows();
